...
function updatesaves()
	local update = {
		...
		CMDTab = CMDTab;
		TabsOff = TabsOff;
		KeepEXTERNITYOn = KeepEXTERNITYOn;
...
function loadsaves()
	...
	KeepEXTERNITYOn = saves.KeepEXTERNITYOn
...
if KeepEXTERNITYOn and syn.queue_on_teleport then
...
function useCommand.advertise()
	...
	while cmdAdvertise do
		local str = "Get Externity today! Best admin GUI, supports paid executors! type in cmd-x on google!"
